		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="card">
					...
					<form method="post" id="update_year_level_form">
						<div class="card-body">
							<div class="form-group"> 
								<input type="hidden" name="year_level_id" value="<?php echo $year_level['year_level_id'] ?>" id="year_level_id" class="form-control" >
							</div>
							<div class="form-group">
								...
								<select name="department" class="form-control" id="department" required>
									...
									if($department->num_rows() > 0 ):
										foreach($department->result_array() as $row):
											if($row['department_id'] == $year_level['department_id'])
											{
												$selected = "selected";
											}
											else
							...
							<div class="form-group">
								...
								<input type="text" name="year_level" value="<?php echo $year_level['year_level'] ?>" id="year_level" class="form-control" placeholder="Year Level" required>
							</div>
						</div>
